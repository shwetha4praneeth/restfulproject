...
public class ExcelCreatingAndWritingProject 
{
	public static void main(String[] args) throws Exception
	{
		...
		for(int i=0;i<emprecs.size();i++)
		{
			...
			r1.createCell(0).setCellValue((String) emprecs.get(i).get("id"));
			r1.createCell(1).setCellValue((String) emprecs.get(i).get("employee_name"));
			r1.createCell(2).setCellValue((String) emprecs.get(i).get("employee_salary"));
			r1.createCell(3).setCellValue((String) emprecs.get(i).get("employee_age"));
